...
long_text = "";  
  ...
  static void event_handler(lv_event_t * e) {
    ...
    if (code == LV_EVENT_CLICKED) {
      ...
      long_text.toCharArray(final_texto, 32);
  ...
  void enviarNotificacao(){
    ...
    if (long_text.length()>1){
     ...
     <p>Em: %d: %d: %d - %s</p>", hr, min, sec, long_text);
...
*/
  ...
  void setup() {
    ...
    if (!disp_draw_buf) {
      ...
      lv_label_set_text(labelbtn01, "Quero ");
      ...
      /*CREATE AN IMGBTN11*/
      lv_obj_t *imgbtn11 = lv_imgbtn_create(screenMain);
      lv_imgbtn_set_src(imgbtn11, LV_IMGBTN_STATE_RELEASED, NULL, &brincar, NULL);
      lv_obj_add_event_cb(imgbtn11, event_handler, LV_EVENT_ALL, label);
      lv_obj_add_style(imgbtn11, &style_def, 0);
      lv_obj_add_style(imgbtn11, &style_pr, LV_STATE_PRESSED);
      lv_obj_add_style(imgbtn11, &style, 0);
      lv_obj_set_size(imgbtn11, 100, 100);
      lv_obj_set_pos(imgbtn11, 120, 160);

      lv_obj_t *labelbtn11 = lv_label_create(imgbtn11);
      lv_label_set_text(labelbtn11, "brincar ");
      lv_obj_align(labelbtn11, LV_ALIGN_TOP_MID, 0, -4);

      /*CREATE AN IMGBTN12*/
      lv_obj_t *imgbtn12 = lv_imgbtn_create(screenMain);
      lv_imgbtn_set_src(imgbtn12, LV_IMGBTN_STATE_RELEASED, NULL, &ajuda, NULL);
      lv_obj_add_event_cb(imgbtn12, event_handler, LV_EVENT_ALL, label);
      lv_obj_add_style(imgbtn12, &style_def, 0);
      lv_obj_add_style(imgbtn12, &style_pr, LV_STATE_PRESSED);
      lv_obj_add_style(imgbtn12, &style, 0);
      lv_obj_set_size(imgbtn12, 100, 100);
      lv_obj_set_pos(imgbtn12, 230, 160);

      lv_obj_t *labelbtn12 = lv_label_create(imgbtn12);
      lv_label_set_text(labelbtn12, "Ajuda ");
      lv_obj_align(labelbtn12, LV_ALIGN_TOP_MID, 0, -4);

      /*CREATE AN IMGBTN13*/
      lv_obj_t *imgbtn13 = lv_imgbtn_create(screenMain);
      lv_imgbtn_set_src(imgbtn13, LV_IMGBTN_STATE_RELEASED, NULL, &passear, NULL);
      lv_obj_add_event_cb(imgbtn13, event_handler, LV_EVENT_ALL, label);
      lv_obj_add_style(imgbtn13, &style_def, 0);
      lv_obj_add_style(imgbtn13, &style_pr, LV_STATE_PRESSED);
      lv_obj_add_style(imgbtn13, &style, 0);
      lv_obj_set_size(imgbtn13, 100, 100);
      lv_obj_set_pos(imgbtn13, 340, 160);

      lv_obj_t *labelbtn13 = lv_label_create(imgbtn13);
      lv_label_set_text(labelbtn13, "Passear ");
      ...
      /*CREATE AN IMGBTN22*/
      lv_obj_t *imgbtn22 = lv_imgbtn_create(screenMain);
      lv_imgbtn_set_src(imgbtn22, LV_IMGBTN_STATE_RELEASED, NULL, &pegar, NULL);
      lv_obj_add_event_cb(imgbtn22, event_handler, LV_EVENT_ALL, label);
      lv_obj_add_style(imgbtn22, &style_def, 0);
      lv_obj_add_style(imgbtn22, &style_pr, LV_STATE_PRESSED);
      lv_obj_add_style(imgbtn22, &style, 0);
      lv_obj_set_size(imgbtn22, 100, 100);
      lv_obj_set_pos(imgbtn22, 230, 270);

      lv_obj_t *labelbtn22 = lv_label_create(imgbtn22);
      lv_label_set_text(labelbtn22, "Pegar ");
      ...
      // /*CREATE AN IMGBTN31*/
      lv_obj_t *imgbtn31 = lv_imgbtn_create(screenMain);
      lv_imgbtn_set_src(imgbtn31, LV_IMGBTN_STATE_RELEASED, NULL, &sair, NULL);
      ...
      lv_label_set_text(labelbtn31, "Sair ");
